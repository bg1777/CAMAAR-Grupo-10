Feature: Responder questionário de avaliação da turma
  ...
  Scenario: Acessar questionário disponível para avaliação
  ...
  Scenario: Responder questionário com sucesso
    Given que estou autenticado no sistema como Participante
  ...
  Scenario: Tentativa de envio com respostas incompletas
    Given que estou autenticado no sistema como Participante
  ...
  Scenario: Participante tenta responder um questionário já enviado
    Given que estou autenticado no sistema como Participante
  ...
  Scenario: Participante tenta responder questionário inexistente
    Given que estou autenticado no sistema como Participante
